setTimeout(async function () {
  ...
  const webSocketUrls = 'wss://localhost:44303/ExamSchedule/,ws://localhost:62259/ExamSchedule/'.split(',');
  const sharedSecret = await getSecret('');
  let connection;
