...
namespace ExamSchedule.Models
{
    public partial class examdataContext : DbContext
    {
        ...
        public virtual DbSet<ComplexRestriction> ComplexRestrictions { get; set; }
        ...
        {
            modelBuilder.Entity<ComplexRestriction>(entity =>
            {
                entity.ToTable("ComplexRestriction");

                entity.HasIndex(e => e.Id, "IX_ComplexRestriction_Id")
                    .IsUnique();
                ...
                entity.HasOne(d => d.Schedule)
                   .WithMany(p => p.ComplexRestrictions)
